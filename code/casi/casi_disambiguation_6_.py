...
class config:
    ...
    TRAIN_FILE = '../../data/AD_CASI/csv_files/train_pairs.csv'
    VAL_FILE = '../../data/AD_CASI/csv_files/dev_pairs.csv'
    TEST_FILE = '../../data/AD_CASI/csv_files/test_pairs.csv'
...
if __name__ == '__main__':
    ...
    with open(details_file_path, 'a') as file:
        file.write('File Name:  Disambiguation 6  ******** with processing changed for CASI AD data:'+config.MODEL_NAME)
